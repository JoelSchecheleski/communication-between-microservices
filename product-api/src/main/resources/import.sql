...
INSERT INTO product(id, name, fk_supplier, fk_category, quantity_available, created_at) VALUES(1003, 'Matrix', 1002, 1002, 2, CURRENT_TIMESTAMP);
INSERT INTO product(id, name, fk_supplier, fk_category, quantity_available, created_at) VALUES(1004, 'Até que nada mais importe', 1002, 1003, 15, CURRENT_TIMESTAMP);
