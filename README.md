...
![Tracing](https://i.imgur.com/B0oqVbV.png)
...
A documentação da API se faz presente no arquivo [API_DOCS.md](https://github.com/JoelSchecheleski/communication-between-microservices/blob/main/API_DOCS.md).

## Deploy no Heroku

As 3 APIs foram publicadas no Heroku, o repositório que foram publicados são esses:

* Auth-API    (PostgreSQL e Coralogix Logging)
* Product-API (Coralogix Logging, Cloud MongoDB e CloudAQMP)
* Sales-API   (Coralogix Logging Heroku Postgres e CloudAQMP)
...
![Dashboard Product-API](https://i.imgur.com/l9aII8e.png)
...
![Requisição](https://i.imgur.com/lZiLClO.png)
...
![Kibana Sales-API](https://i.imgur.com/AcYW2UY.png)
...
![Kibana Product-API](https://i.imgur.com/UxMak51.png)
